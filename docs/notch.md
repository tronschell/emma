...
| Needs | macOS Accessibility for the helper; no equivalent grant is required on Windows |
...
`MAX_CURSOR_ORBS`, **8**; default `⌘1`/`Ctrl+1`, `⌘2`/`Ctrl+2`, `⌘3`/`Ctrl+3`,
▣ Screen, ✎ Draw, ⧉ Save page):
