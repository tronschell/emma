...
import { connectionCommand } from "../dist-main/main/connections.js";
...
test("Windows connection commands stay pinned to resolved paths", () => {
  assert.equal(connectionCommand("C:\\Program Files\\GitHub CLI\\gh.exe", "win32"), '"C:\\Program Files\\GitHub CLI\\gh.exe"');
  assert.equal(connectionCommand("gh", "darwin"), "gh");
});
