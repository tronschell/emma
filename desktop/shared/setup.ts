...
export const SETUP_PERMISSIONS = [
  ...
  },
  {
    ...
    why: "Nothing is captured until you ask for it — the ▣ orb, the ✎ pen, or a save to your knowledge base. Each capture is compressed on this Mac and travels only with the turn you send it with.",
